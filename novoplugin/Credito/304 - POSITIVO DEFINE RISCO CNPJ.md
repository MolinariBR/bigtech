Este documento tem o intuito de auxiliar no desenvolvimento da consulta **304 - POSITIVO DEFINE RISCO CNPJ**. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1464 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1464" )_|
...
|CPFCNPJ|Numérico/Inteiro|**Obrigatório**|CNPJ (Pessoa Jurídica) . Somente números, com 14 caracteres. Ex: 14457854000191.|
|TipoPessoa|Alfanumérico|**Obrigatório**|Informe "J".|
||   |   |   |
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "1464-304 - POSITIVO DEFINE RISCO CNPJ",  
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "",  
            "CLIENTE": "",  
            "DATA_HORA_CONSULTA": "23/12/2025 11:46",  
            "TERMINAL": "",  
            "SOLICITANTE": "",  
            "PDF": "",  
            "PDF_ALERTA": "",  
