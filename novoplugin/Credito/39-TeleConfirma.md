Este documento tem o intuito de auxiliar no desenvolvimento da consulta **39-TeleConfirma**. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1450 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1450" )_|
...
|DDD|Numérico|**Obrigatório**|Somente números, 2 dígitos. Ex: 31, 21, 11|
|Telefone|Numérico|Opcional|Somente números, sem mascara ou espaços em branco (8 a 9 dígitos). Ex: 24589977, 78523699, 995237844|
||   |   |   |
...
|---|---|---|---|
|32|Teleconfirma|Confirmação dos dados e endereço do assinante do telefone informado.||
...
{  
    ...
    "CREDCADASTRAL": {  
        "TITULAR_DO_TELEFONE": {  
            ...
            "TELEFONES": [  
                {  
                    "NOME": "DANIEL TOLENTINO BERNARDES",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "062.221.696-19",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "AV JOAO MARIA ALKIMIM",  
                    "NUMERO": "875",  
                    "COMPLEMENTO": "AP/CJ 301",  
                    "BAIRRO": "",  
                    "CIDADE": "PATROCINIO",  
                    "CEP": "38740000",  
                    "UF": "MG",  
                ...
                {  
                    ...
                    "DOCUMENTO": "24.433.714/0001-51",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "R JACOB MARRA",  
                    "NUMERO": "448",  
                    "COMPLEMENTO": "SALA 03",  
                    "BAIRRO": "CENTRO",  
                    "CIDADE": "PATROCINIO",  
                ...
                {  
                    "NOME": "VALDIR ANTONIO DOS SANTOS",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "266.995.406-53",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "",  
                    "NUMERO": "",  
                    ...
                    "UF": "",  
                    "NASCIMENTO": "",  
                    "OBITO": "SIM (18/04/2008)",  
                    "SEXO": "MASCULINO",  
                    "NOME_MAE": ""  
                },  
                {  
                    "NOME": "JOSE PEREIRA DOS SANTOS",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "183.317.856-49",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "",  
                    "NUMERO": "",  
                ...
                {  
                    "NOME": "VALDETE APARECIDA DOS SANTOS OLIVEIRA",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "753.861.866-04",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "",  
                    "NUMERO": "",  
                ...
                {  
                    "NOME": "VILMA MARIA DOS SANTOS",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "491.350.316-20",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "",  
                    "NUMERO": "",  
                ...
                {  
                    "NOME": "IVAN INACIO LOURENCO",  
                    "TIPO_PESSOA": "FISICA",  
                    "DOCUMENTO": "724.325.606-63",  
                    "DDD": "34",  
                    "NUM_TELEFONE": "38320124",  
                    "ENDERECO": "",  
                    "NUMERO": "",  
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "",  
            "CLIENTE": "",  
            "DATA_HORA_CONSULTA": "23/12/2025 11:42",  
            "TERMINAL": "",  
            "SOLICITANTE": "",  
            "PDF": "",  
            "PDF_ALERTA": "",  
