Este documento tem o intuito de auxiliar no desenvolvimento da consulta **36-Busca por Nome+UF**. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1449 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1449" )_|
...
|UF|Alfanumérico|**Obrigatório**|Unidade federativa, informe somente 2 caracteres. Ex: RJ, MG, SP|
|NomeCompleto|Alfanumérico|**Obrigatório**|Nome completo, sem acentos. Não tem limite máximo de caracteres.|
||   |   |   |
...
|---|---|---|---|
|39|Dados Gerais|Nome, Documento e telefone associados ao parâmetros consultado||
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "1449-36-Busca por Nome+UF",  
    ...
    "CREDCADASTRAL": {  
        "DADOS_GERAIS": {  
            ...
            "DADOS": [  
                {  
                    "NOME": "GILMARA DE ARAUJO 06636029633",  
                    "TIPO_PESSOA": "JURIDICA",  
                    "DOCUMENTO": "29.059.126/0001-13",  
                    "NASCIMENTO": "13/11/2017",  
                    "OBITO": "NAO",  
                    "SEXO": "",  
                    "CIDADE": "",  
                    "UF": "MG,",  
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "",  
            "CLIENTE": "",  
            "DATA_HORA_CONSULTA": "23/12/2025 11:45",  
            "TERMINAL": "",  
            "SOLICITANTE": "",  
            "PDF": "",  
            "PDF_ALERTA": "",  
