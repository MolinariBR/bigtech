Este documento tem o intuito de auxiliar no desenvolvimento da consulta **416-Crlv/SP***. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1532 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1532" )_|
