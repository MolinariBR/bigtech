Este documento tem o intuito de auxiliar no desenvolvimento da consulta **320-Contatos Por CEP**. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1465 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1465" )_|
...
|Cep|Numérico|**Obrigatório**|Número do CEP, somente números sem mascara. Ex: 01025478, 35700785, 29458214|
||   |   |   |
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "",  
            "CLIENTE": "",  
            "DATA_HORA_CONSULTA": "23/12/2025 11:51",  
            "TERMINAL": "",  
            "SOLICITANTE": "",  
            "PDF": "",  
            "PDF_ALERTA": "",  
