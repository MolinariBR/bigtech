Este documento tem o intuito de auxiliar no desenvolvimento da consulta **424-ValidaID - Localizacao**. Deve ser enviada uma solicitação POST com o **JSON de requisição** para a URL do serviço.
...
|---|---|---|---|
|CodigoProduto|Numérico/Inteiro|**Obrigatório**|Informe o código : 1475 _(Apesar de ser um número inteiro, deve ser enviado entre aspas duplas, como uma string. Ex: "1475" )_|
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "1475-424-ValidaID - Localizacao",  
...
{  
    "HEADER": {  
        "INFORMACOES_RETORNO": {  
            ...
            "PRODUTO": "",  
            "CLIENTE": "",  
            "DATA_HORA_CONSULTA": "23/12/2025 11:50",  
            "TERMINAL": "",  
            "SOLICITANTE": "",  
            "PDF": "",  
            "PDF_ALERTA": "",  
