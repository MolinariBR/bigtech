...
**Referência**: /consulta/credito (página, frontend-user)  
**Referência**: Execução via plugin consulta (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/consulta/credito.tsx  

**Criterios de Aceite:**
- [ ] Seleção de card de consulta de crédito disponível via plugins ativos
...
**Para** obter informações normalizadas  
**Referência**: Consulta, Plugin (entidades)  
**Referência**: /consulta/cadastral (página, frontend-user)  
**Referência**: Execução via plugin consulta (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/consulta/cadastral.tsx  

**Criterios de Aceite:**
- [ ] Seleção de card de consulta cadastral disponível via plugins ativos
- [ ] Execução debita créditos (User.credits - Consulta.cost)
- [ ] Resultado exibido em JSON normalizado (Consulta.output)
- [ ] Fallback para fonte alternativa se plugin falhar
- [ ] Histórico atualizado automaticamente
...
**Para** obter informações normalizadas  
**Referência**: Consulta, Plugin (entidades)  
**Referência**: /consulta/veicular (página, frontend-user)  
**Referência**: Execução via plugin consulta (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/consulta/veicular.tsx  

**Criterios de Aceite:**
- [ ] Seleção de card de consulta veicular disponível via plugins ativos
- [ ] Execução debita créditos (User.credits - Consulta.cost)
- [ ] Resultado exibido em JSON normalizado (Consulta.output)
- [ ] Fallback para fonte alternativa se plugin falhar
- [ ] Histórico atualizado automaticamente
...
**Referência**: /relatorios/consultas (página, frontend-user)  
**Referência**: Relatório e filtros (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/relatorios/consultas.tsx  
...
**Referência**: /financeiro/comprar (página, frontend-user)  
**Referência**: Integração com plugin pagamento (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/financeiro/comprar.tsx  
...
**Referência**: /financeiro/extrato (página, frontend-user)  
**Referência**: Listagem de transações (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/financeiro/extrato.tsx  
...
**Referência**: Billing (entidade)  
**Referência**: /financeiro/boletos (página, frontend-user)  
**Referência**: Listagem e download (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/financeiro/boletos.tsx  
...
**Referência**: N/A  
**Referência**: /lgpd (página, frontend-user)  
**Referência**: Página estática (funcionalidade)  
**Endereço Fisico**: frontend-user/src/pages/lgpd.tsx  
...
## Tasks 
 - [ ] TASK-001. Título da Tarefa
   ...
   - Endereço Físico: Caminho do arquivo ou módulo relevante (ex.: frontend-user/src/pages/consulta/credito.tsx)
