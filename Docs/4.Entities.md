...
* **Regras**: Autenticação via CPF/CNPJ; unicidade de `identifier` por tenant. Acesso a plugins de consulta controlado via `allowedPlugins` (subset dos plugins ativos no tenant).
