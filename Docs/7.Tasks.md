...
### Autenticação e CORE
- [ ] TASK-004. Implementar Autenticação de Usuário
  ...
  - [ ] TASK-004.1 Escrever testes property-based para TASK-004
    - **Propriedade 1: JWT válido para usuários isolados por tenant**
    - **Valida: Requisito 2.1**

- [ ] TASK-005. Implementar Autenticação de Administrador
